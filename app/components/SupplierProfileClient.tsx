    ...
    return (
      <main className="mx-auto grid min-h-[60vh] w-full max-w-4xl place-items-center px-4 py-16 text-center sm:px-6 lg:px-8">
        <div className="w-full rounded-lg border border-slate-200 bg-white p-6 shadow-sm sm:p-10">
          <h1 className="text-2xl font-black text-slate-950 sm:text-3xl">Supplier not found</h1>
  ...
  return (
    <main className="bg-slate-50">
      <section className="border-b border-slate-200 bg-white py-10">
        <div className="mx-auto grid w-full max-w-7xl grid-cols-1 gap-8 px-4 sm:px-6 lg:grid-cols-[minmax(0,1fr)_minmax(0,0.75fr)] lg:px-8">
          <div>
            <div className="flex flex-col gap-5 sm:flex-row sm:items-center">
              <img
                alt={`${supplier.companyName} profile`}
                className="aspect-square h-auto w-20 flex-shrink-0 rounded-lg border border-slate-200 object-cover sm:w-24"
          ...
          <aside className="grid gap-4 rounded-lg border border-slate-200 bg-slate-50 p-4 sm:p-5">
            <LocationButton />
            <div>
            ...
            <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
              <a
                className="w-full rounded-md bg-emerald-600 px-4 py-3 text-center font-black text-white transition hover:bg-emerald-700"
                href={getTelUrl(supplier.phoneNumber)}
              >
                Call Now
              </a>
              <a
                className="w-full rounded-md border border-emerald-200 bg-emerald-50 px-4 py-3 text-center font-black text-emerald-800 transition hover:bg-emerald-100"
      ...
      <section className="py-10">
        <div className="mx-auto grid w-full max-w-7xl grid-cols-1 gap-6 px-4 sm:px-6 lg:grid-cols-[minmax(0,0.8fr)_minmax(0,1fr)] lg:px-8">
          <article className="overflow-hidden rounded-lg border border-slate-200 bg-white p-4 shadow-sm sm:p-6">
          ...
          <article className="overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm">
            <iframe
              className="h-[42vh] min-h-64 max-h-96 w-full"
              loading="lazy"
...
function SupplierSkeleton() {
  return (
    <main className="mx-auto grid w-full max-w-7xl grid-cols-1 gap-8 px-4 py-10 sm:px-6 lg:px-8">
