  ...
  return (
    <main className="mx-auto grid min-h-[60vh] w-full max-w-4xl place-items-center px-4 py-16 text-center sm:px-6 lg:px-8">
      <div className="w-full rounded-lg border border-slate-200 bg-white p-6 shadow-sm sm:p-10">
        ...
        <h1 className="mt-3 text-2xl font-black text-slate-950 sm:text-3xl">MarketPlaceX hit an error.</h1>
        <p className="mt-3 text-slate-600">Try again, or return to the marketplace listings.</p>
        <button
          className="mt-6 w-full rounded-md bg-cyan-700 px-5 py-3 font-black text-white transition hover:bg-cyan-800 sm:w-auto"
